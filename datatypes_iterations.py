...
def intro():
    print("\n")
    print("""Iterations or looping can be performed by 'for' and 'while' loops.
...
while (i < 10):
    i += 1
    print(i)""",
            """Sets 1 to the variable 'i', then creates a conditional
...
for i in s:
    print(i)""",
            """Sets the string "Hello World" to the variable 's',
...
for i in list1:
    print(i)""",
            """  Sets a list of integers to the variable 'list1', then runs
...
assigned to 'i' will be printed."""],
        ...
        ["""for i in range(0, 10):
    print (i)""",
            """Runs a 'for' loop over a range of integers starting from 0
